    ...
    def _load_responses(self):
        ...
        return {
            CHATBOT_INTENTS['GREETING']: [
                ...
                "Hi there! I'm here to help with sepsis information. What would you like to know?",
            ...
            CHATBOT_INTENTS['HELP']: [
                "I can help you with: sepsis risk ,learning about symptoms, prevention tips, and treatment information.",
            ...
            'general_query': [
                "I'm specialized in sepsis-related information. Could you ask about sepsis prevention, symptoms, or treatment?",
                "For sepsis-related questions, I can help with  explanations, symptoms, and prevention."
            ],
            'error': [
            ...
            "CAUSES": [
                "Sepsis occurs when the body's response to an infection damages its own tissues. Common sources include lung infections, urinary tract infections, abdominal infections, and bloodstream infections.",
                "Sepsis is usually caused by bacterial infections, but viruses and fungi can also trigger it. It starts from an infection that spreads or triggers a severe immune reaction.",
                "The main causes of sepsis are untreated or severe infections. When the immune system overreacts, it can lead to organ dysfunction."
],
